    ...
    >
      ...
      >
        <header class="mb-5">
          ...
          <div v-if="subtitle" class="text-gray-100" :class="subtitleClass">
            {{ subtitle }}
          </div>
        </header>
...
.overlay {
  @apply relative z-[1] after:absolute after:inset-0 after:w-full after:h-full after:bg-gray-900 after:bg-opacity-70 after:rounded-md after:z-[-1];
}
</style>
