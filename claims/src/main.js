...
const app = createApp(App)
  ...
  .use(SDSLayouts, { BASE_URL_LOGIN: import.meta.env.VITE_BASE_URL_LOGIN, BASE_PATH: import.meta.env.VITE_BASE_PATH, REDIRECT_URL: import.meta.env.VITE_REDIRECT_URL })
  .use(pinia)
  .use(i18n)
  .use(Vue3Toastify, {
    autoClose: 3000,
