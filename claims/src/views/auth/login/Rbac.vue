...
const handleLogin = async () => {
  try {
    ...
    if (response.data.success_code === 200 && response.data.data.token) {      
      ...
      let userAppData = { id: response.data.data.user.id, name: response.data.data.user.name, email: response.data.data.user.email, token: response.data.data.token, users, rbac };
