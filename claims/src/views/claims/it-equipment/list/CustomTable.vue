    ...
    <div class="overflow-x-auto">
      <table class="min-w-full text-sm table-fixed">
        ...
        <tbody class="bg-white">
          <tr v-for="(row, idx) in tableData" :key="idx" class="relative border-t align-middle " :class="[props.showOpen ? 'hover:bg-gray-100' : '']" style="height: 70px"
            ...
            <td v-for="col in columnMeta" :key="col.accessorKey" class="px-1 py-1 w-[250px] text-center align-middle">
              ...
              class="absolute top-5 right-12 px-4 py-1 border-1 text-gray-700 bg-white rounded-full">
              Open</button>
            </td>
