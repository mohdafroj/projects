      ...
      <div class="rich-text-editor quill-wrapper">
        ...
        <div class="border rounded-lg">
          ...
          <div v-if="editorMode === 'rich'">
            ...
            <div class="border-b bg-gray-50 p-2">
              <div class="flex flex-wrap items-center gap-2">
                ...
                <!-- Alignment -->
                <button type="button" @click="formatText('justifyLeft')" class="toolbar-btn" title="Align Left"
                  width="20" height="20">
                  <Icon icon="mdi:format-align-left" />
                </button>
                <button type="button" @click="formatText('justifyCenter')" class="toolbar-btn" title="Align Center"
                  width="20" height="20">
                  <Icon icon="mdi:format-align-center" />
                </button>
                <button type="button" @click="formatText('justifyRight')" class="toolbar-btn" title="Align Right"
                  width="20" height="20">
                ...
                <!-- Table -->
                <button type="button" @click="insertTable" class="toolbar-btn bg-green-100" title="Insert Table">
                ...
                <!-- Utilities -->
                <button type="button" @click="formatText('removeFormat')" class="toolbar-btn" title="Clear Format">
            ...
            <div ref="richEditor" class="rich-editor-content p-4 min-h-[460px] focus:outline-none"
              contenteditable="true" @input="onRichEditorInput" @keydown="onKeyDown" @paste="onRichEditorPaste"></div>
          </div>
          ...
          <div v-else>
            ...
            <textarea v-model="content" @input="onContentChange"
        ...
        <div v-if="showTableModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div class="bg-white rounded-lg p-6 w-96">
            ...
            <div class="flex justify-end space-x-2">
              <button type="button" @click="showTableModal = false" class="px-4 py-2 bg-gray-300 text-gray-700 rounded">
                Cancel
              </button>
              <button type="button" @click="createTable" class="px-4 py-2 bg-blue-600 text-white rounded">
                Insert
              </button>
            </div>
          </div>
...
console.log('temp detaillsskam  ', MemberTemplateData.value.terms_start_date)
