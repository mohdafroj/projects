<template>
  <div class="flex items-center w-max gap-4 px-2 py-3">
    <select
      ...
      class="border rounded px-1 py-1 text-md text-gray-700 dark:text-gray-300 focus:outline-none"
    >
    ...
    <select
      v-model="sortOrder"
      class="border rounded px-1 py-1 dark:bg-gray-800 text-md text-blue-600 bg-blue-50 focus:outline-none"
