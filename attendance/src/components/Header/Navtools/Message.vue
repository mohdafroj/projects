<template>
  <Dropdown
    classMenuItems="md:w-[335px] w-min top-[54px]"
    classItem="px-4 py-2"
  >
    <span
    ...
    <template v-slot:menus>
      ...
      <div class="divide-y divide-slate-100 dark:divide-slate-800">
        <MenuItem v-for="(item, i) in newMessages" :key="i" v-slot="{ active }">
          <div
            :class="`${
              active
          ...
          >
            <div
              class="flex text-left  space-x-3"
            >
              <div class="flex-none">
                <div
...
const newMessages = ref(message.slice(0, 4));
</script>
