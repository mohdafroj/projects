  ...
  <div>
    ...
    <div 
      :class="[
        ...
        {
          'grid-cols-1 items-center justify-center': multiple == false,
          'md:grid-cols-7 xl:grid-cols-10 border-solid border-blue-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800': multiple,
    ...
    >
      <div v-for="(item, index) in files" :key="'fileIndex' + index">
        ...
        >
          <div v-if="isImage(item.file)" class="relative flex items-center justify-center h-[150px] aspect-square">
            <img :src="item.url" class="object-cover w-full h-full bg-white" alt="File preview" />
          </div>
      ...
      <div
        v-if="!(multiple == false && files.length == 1)"
    ...
    >
      <div v-if="Object.keys(previewFile).length" class="w-full h-[95vh] flex items-center justify-center">
          ...
          <img v-if="isImage(previewFile.file)" :src="previewFile.url" class="object-cover w-full h-full bg-white" alt="File preview" />          
          <embed
