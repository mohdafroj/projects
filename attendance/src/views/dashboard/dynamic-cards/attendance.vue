      ...
      <div class="grid md:grid-cols-4 gap-4 w-full max-w-5xl">
        <div class="col-span-2 text-left">
          <div class="grid grid-cols-2 gap-4 mt-4">
            <div class="relative bg-emerald-50 dark:bg-slate-900 border px-4 py-4 rounded-lg shadow-sm flex items-center dark:border-slate-700 dark:text-slate-100 overflow-hidden ">
              <div>
                <div class="text-sm text-gray-700">Present Days</div>
                <div class="text-2xl font-bold text-green-600">{{ chartSessionData.attendance_till_date }}</div>
              </div>
              <Icon 
                icon="heroicons:user" 
                class="absolute right-0 bottom-0 text-green-300 text-8xl opacity-10 translate-x-1/4 translate-y-1/4 transform transition-transform duration-300 hover:rotate-12" 
              />
            </div>

            <div class="relative bg-red-50 dark:bg-slate-900 border px-4 py-4 rounded-lg shadow-sm flex items-center dark:border-slate-700 dark:text-slate-100 overflow-hidden ">
            <div>
                <div class="text-sm text-gray-700">Absence:</div>
                <div class="text-2xl font-bold text-red-00">{{ chartSessionData.absence }}</div>
              </div>
              <Icon 
                icon="heroicons:user-minus" 
                class="absolute right-0 bottom-0 text-red-300 text-8xl opacity-10 translate-x-1/4 translate-y-1/4 transform transition-transform duration-300 hover:rotate-12" 
              />
            
          </div>

          <div class="relative bg-orange-50 dark:bg-slate-900 border px-4 py-4 rounded-lg shadow-sm flex items-center dark:border-slate-700 dark:text-slate-100 overflow-hidden ">
            <div>
                <div class="text-sm text-gray-700">Leave:</div>
                <div class="text-2xl font-bold text-orange-600">{{ chartSessionData.leave }}</div>
              </div>
              <Icon 
                icon="heroicons:home-modern" 
                class="absolute right-0 bottom-0 text-orange-300 text-8xl opacity-10 translate-x-1/4 translate-y-1/4 transform transition-transform duration-300 hover:rotate-12" 
              />
            
          </div>

          <div class="relative bg-cyan-50 dark:bg-slate-900 border px-4 py-4 rounded-lg shadow-sm flex items-center dark:border-slate-700 dark:text-slate-100 overflow-hidden ">
            <div>
                <div class="text-sm text-gray-700">Remaining Days:</div>
                <div class="text-2xl font-bold text-cyan-600">{{ chartSessionData.remaining_days }}</div>
              </div>
              <Icon 
                icon="heroicons:calendar-days" 
                class="absolute right-0 bottom-0 text-cyan-400 text-8xl opacity-10 translate-x-1/4 translate-y-1/4 transform transition-transform duration-300 hover:rotate-12" 
              />
            
          </div>
      
            <!-- <div class="bg-emerald-50 dark:bg-slate-900 border px-3 py-3 rounded-lg shadow-sm dark:border-slate-700 dark:text-slate-100">
             
              <div class="text-sm text-gray-700">Attendance: </div>
